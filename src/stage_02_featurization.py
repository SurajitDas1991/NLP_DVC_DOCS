...
def main(config_path, params_path):
    ...
    featurized_train_data_dir_path=os.path.join(featurized_data_dir_path,artifacts["FEATURIZED_DATA_TRAIN"])
    featurized_test_data_dir_path=os.path.join(featurized_data_dir_path,artifacts["FEATURIZED_DATA_TEST"])
    ...
    save_matrix(df=df_train, text_matrix=train_words_tfidf_matrix, out_path=featurized_train_data_dir_path)
    ...
    save_matrix(df=df_test, text_matrix=test_words_tfidf_matrix, out_path=featurized_test_data_dir_path)
